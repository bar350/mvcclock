...
var frame$1 = {
  props: {
    ...
    transition: {
      type: [String, Object],
      default: function (_) { return ({ name: 'slide', duration: 200 }); }
    },
    'ios:transition': {
      type: [String, Object],
      default: ''
  ...
  methods: {
    ...
    _composeTransition: function _composeTransition() {
      var this$1 = this;
      ...
      for (var prop in propMap) {
        if (this$1[prop]) {
          var name = propMap[prop];
          result[name] = {};

          if (typeof this$1[prop] === 'string') {
            result[name].name = this$1[prop];
          } else {
            extend(result[name], this$1[prop]);
          }
        }
      }
